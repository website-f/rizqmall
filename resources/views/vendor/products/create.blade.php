                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="text" name="short_description"
                                    placeholder="Brief summary (shown in listings)" value="{{ old('short_description') }}"
                                    maxlength="500" />
                            </div>

                            <div>
                                <label class="form-label">Full Description <span class="text-danger">*</span></label>
                                <textarea class="form-control" name="description" rows="8" placeholder="Detailed description..." required>{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
