...
<body>
    ...
    <main class="main" id="top">
                        ...
                        <div class="row gx-0 gy-2 w-100 flex-between-center">
                            <div class="col-auto"><a class="text-decoration-none" href="/">
                                    <div class="d-flex align-items-center"><img
                                            src="{{ asset('assets/rizqmall.jpeg') }}" alt="phoenix" width="67" />
                                ...
                                <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-2"
                                            ...
                                            data-bs-title="Rizq Wallet">
                                            <span class="text-body-tertiary" data-feather="credit-card"
                                                style="height:20px;width:20px;"></span>
                                        </a>
                                    </li>
                                            ...
                                            <div class="card position-relative border-0">
                                                <div class="card-body p-0">
                                                    ...
                                                    <p class="text-body-tertiary text-xs">
                                                        {{ auth()->user()->is_admin ? 'Admin' : ucfirst(auth()->user()->user_type ?? 'Customer') }}
                                                    </p>
                                                    </div>
                                                </div>
                                                <div class="overflow-auto scrollbar" style="max-height: 14rem;">
                                                    ...
                                                    {{-- Vendor options (for vendors OR admins who have stores) --}}
        ...
        <nav class="ecommerce-navbar navbar navbar-expand-lg navbar-light bg-body-emphasis">
            <div class="container-small d-flex align-items-center w-100" data-navbar="data-navbar">
                ...
                @endphp
                <div class="collapse navbar-collapse justify-content-end flex-grow-1" id="primaryNav">
            ...
            <div class="container-small">
                <div class="row justify-content-between gy-4">
                    <div class="col-12 col-lg-4">
                        <div class="d-flex align-items-center mb-3"><img src="{{ asset('assets/rizqmall.jpeg') }}"
                                alt="phoenix" width="87" />
                    ...
                    <div class="col-6 col-md-auto">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <a class="mb-1 fw-semibold fs-9 d-flex" href="https://www.facebook.com/rizqmallhybridapps"
                                target="_blank"><span class="fab fa-facebook-square text-primary me-2 fs-8"></span>
                                <span class="text-body-secondary">Facebook</span>
                            </a>
                            <a class="mb-1 fw-semibold fs-9 d-flex" href="https://www.tiktok.com/@rizqmall?lang=en"
                                target="_blank"><span class="fab fa-tiktok text-info me-2 fs-8"></span>
        ...
        <footer class="footer position-relative">
            <div class="row g-0 justify-content-between align-items-center h-100">
                <div class="col-12 col-sm-auto text-center">
                    <p class="mb-0 mt-2 mt-sm-0 text-body">Thank you for creating with Rizqmall<span
                            class="d-none d-sm-inline-block"></span><span
                            class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none" />2024 &copy;</p>
                </div>
                <div class="col-12 col-sm-auto text-center">
