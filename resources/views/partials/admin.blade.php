            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="/">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img src="{{ asset('assets/rizqmall.jpeg') }}"
                                    alt="phoenix" width="67" />
                                <h5 class="logo-text ms-2 d-none d-sm-block">Rizqmall</h5>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser"
                            ...
                            <div class="avatar avatar-l ">
                                <img class="rounded-circle "
                                    src="{{ auth()->user()->avatar ?? asset('defUse.jpg') }}" alt="" />
                                ...
                                <div class="card-body p-0">
                                    <div class="text-center pt-4 pb-3">
                                        <div class="avatar avatar-xl ">
                                            <img class="rounded-circle "
                                                src="{{ auth()->user()->avatar ?? asset('defUse.jpg') }}"
                                                alt="" />

                                        </div>
                                        <h6 class="mt-2 text-body-emphasis">{{ auth()->user()->name }}</h6>
                                        <p class="text-muted fs-9 mb-0">{{ auth()->user()->email }}</p>
                                    </div>
                                ...
                                <div class="card-footer p-0 border-top border-translucent">
                                    <div class="px-3 py-2">
                                        <form action="{{ route('auth.logout') }}" method="POST"
                                            ...
                                            @csrf
                                            <button type="submit"
                                                class="btn btn-phoenix-danger d-flex align-items-center justify-content-center w-100">
