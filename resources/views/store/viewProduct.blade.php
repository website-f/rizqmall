...
<div class="product-detail-container">
    ...
    <div class="row g-4">
            ...
            <div class="image-gallery">
                ...
                <div class="thumbnail-gallery">
                    ...
                    <div class="thumbnail-item {{ $index === 0 ? 'active' : '' }}"
                        data-image="{{ $image->url }}" onclick="changeMainImage(this)">
        ...
        <div class="col-lg-7">
            ...
            ($product->is_fragile || $product->is_biodegradable || $product->is_frozen || $product->has_expiry))
            <div class="attribute-badges">
                ...
                <span class="attribute-badge">
                    ...
                    Expiry:
                    {{ $product->expiry_date ? $product->expiry_date->format('M d, Y') : 'No expiry date' }}
                </span>
                @endif
            </div>
            @endif
            ...
            <div class="alert alert-warning border-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0 small">This medication requires a valid prescription. Please upload your
                        prescription during checkout.</p>
                </div>
            </div>
            @endif
            ...
            <div class="variant-section">
                ...
                <div class="variant-group">
                    <label class="variant-label">
                        {{ $variantType->name }}:
                        <span class="text-primary" id="selected_{{ $variantType->id }}">Please
                            select</span>
                    </label>
                    <div class="variant-options">
                        ...
                        <button type="button"
                            ...
                            data-type="{{ $variantType->id }}" data-value="{{ $option->value }}"
                            @if ($variantType->display_type === 'color_swatch' && $option->color_code) style="background-color: {{ $option->color_code }};"
                            title="{{ $option->value }}" @endif
            ...
            <div class="tab-pane fade" id="shipping">
                ...
                <table style="width: 100%;">
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        ...
                        <td style="padding: 16px 0; color: #1f2937;">{{ $product->length }} ×
    ...
    async function toggleWishlist(button) {
        ...
        try {
            ...
            if (contentType && contentType.indexOf("application/json") !== -1) {
                ...
                // Assuming redirection or HTML error page
                if (response.redirected) {
                    ...
                    console.error('Wishlist error (text):', text);
