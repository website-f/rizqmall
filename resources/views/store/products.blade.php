...
@section('content')
<style>
    .product-form-container { max-width: 1400px; margin: 0 auto; padding: 20px; }
    ...
    .image-upload-zone:hover { border-color: #3b82f6; background: #eff6ff; }
    ...
    .product-type-toggle input[type="radio"] { display: none; }
    ...
    .variant-option-btn:hover { border-color: #3b82f6; }
...
<div class="product-form-container">
    <nav class="mb-4" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('store.profile', $store->slug) }}">{{ $store->name }}</a></li>
    ...
    <form action="{{ route('products.store', ['store' => $store->id]) }}" method="POST" enctype="multipart/form-data" id="productForm">
        @csrf
            ...
            <div class="col-12 col-xl-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <label class="form-label">{{ ucfirst($type) }} Name <span class="text-danger">*</span></label>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="product-type-toggle">
                            <input type="radio" name="product_type" id="typeSimple" value="simple" checked />
                        ...
                        <div class="form-text mt-3">
                            Simple: Single item without variations. Variable: Multiple options like size, color, etc.
                        </div>
                    </div>
                </div>
                @else
                        ...
                        <div class="row g-3 mt-2" id="simpleInventory">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="number" name="stock_quantity"
                                       placeholder="100" value="{{ old('stock_quantity', 0) }}" />
                            </div>
                            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="fragile" name="is_fragile" value="1">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="biodegradable" name="is_biodegradable" value="1">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="frozen" name="is_frozen" value="1">
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="hasExpiry" name="has_expiry" value="1">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label class="form-label">Service Duration (minutes) <span class="text-danger">*</span></label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initVariantBuilder() {
        ...
        container.innerHTML = '<p class="text-muted mb-3">Select variant types (e.g., Size, Color) and enter options separated by commas:</p>';
        ...
        variantTypes.forEach(type => {
            ...
            document.getElementById(`varType${type.id}`).addEventListener('change', function() {
                document.getElementById(`varOptions${type.id}`).style.display = this.checked ? 'block' : 'none';
    ...
    function generateVariants() {
        ...
        combinations.forEach((combo, index) => {
            ...
            Object.keys(selectedVariantTypes).forEach((typeId, i) => {
                options[typeId] = { value: comboArray[i] || comboArray[0] };
            });
    ...
    if (productForm) {
        productForm.addEventListener('submit', function(e) {
            ...
            if (productTypeRadio && productTypeRadio.value === 'variable' && generatedVariants.length === 0) {
                e.preventDefault();
            ...
            if (selectedFiles.length === 0) {
                const confirmSubmit = confirm('No images uploaded. Do you want to continue without images?');
                if (!confirmSubmit) {
                    e.preventDefault();
                    return false;
                }
