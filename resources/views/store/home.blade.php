...
@section('content')
    ...
    <section class="py-0 px-xl-3">
        <div class="container px-xl-0 px-xxl-3">
            ...
            <div class="row g-3 mb-9">
                <div class="col-12">
                    <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                        <div class="bg-holder z-n1 product-bg" style="background-image:url({{ asset('assets/img/e-commerce/whooping_banner_product.png') }});background-position: bottom right;">
                        </div>
                        <div class="bg-holder z-n1 shape-bg" style="background-image:url({{ asset('assets/img/e-commerce/whooping_banner_shape_2.png') }});background-position: bottom left;">
                        </div>
                        ...
                        <a class="btn btn-lg btn-primary rounded-pill banner-button" href="{{ route('products.index') }}">Shop Now</a>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="gift-items-banner w-100 rounded-3 overflow-hidden">
                        <div class="bg-holder z-n1 banner-bg" style="background-image:url({{ asset('assets/img/e-commerce/gift-items-banner-bg.png') }});">
                        </div>
                        <div class="banner-text text-md-center">
                            ...
                            <a class="btn btn-lg btn-primary rounded-pill banner-button" href="{{ route('products.index') }}">Buy Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-3 overflow-hidden">
                        <div class="bg-holder z-n1 banner-bg" style="background-image:url({{ asset('assets/img/e-commerce/best-in-market-bg.png') }});">
                        </div>
                        <div class="row align-items-center w-sm-100">
                            <div class="col-8">
                                <div class="banner-text">
                                    <h2 class="text-white fw-bolder fs-sm-4 mb-5">RizqMall<br><span class="fs-7 fs-sm-6">Best in Malaysia</span></h2>
                                    <a class="btn btn-lg btn-warning rounded-pill banner-button" href="{{ route('products.index') }}">Shop Now</a>
                                </div>
                            </div>
                            <div class="col-4">
            ...
            <div class="row g-4 mb-6">
                <div class="col-12">
                    ...
                    <div class="swiper-theme-container products-slider">
                        <div class="swiper theme-slider" data-swiper='{"slidesPerView":1,"spaceBetween":16,"breakpoints":{"450":{"slidesPerView":2,"spaceBetween":16},"768":{"slidesPerView":3,"spaceBetween":20},"1200":{"slidesPerView":4,"spaceBetween":16},"1540":{"slidesPerView":5,"spaceBetween":16}}}'>
                                        ...
                                        <div class="position-relative text-decoration-none product-card h-100">
                                            <div class="d-flex flex-column justify-content-between h-100">
                                                <div>
                                                    ...
                                                    {{-- Product Info --}}
                                                    <a class="stretched-link text-decoration-none" href="{{ route('product.show', $product->slug) }}">
                                                        <h6 class="mb-2 lh-sm line-clamp-3 product-name text-body-emphasis">
                                                            {{ $product->name }}
                                                        </h6>
                                                    </a>
                                                    ...
                                                    {{-- Stock Status --}}
                                                    @php
                                                        $stockQty = $product->product_type === 'simple' 
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        @if($product->sale_price)
                                                            <p class="me-2 text-body text-decoration-line-through mb-0 fs-8">
            ...
            <div class="row g-4 mb-6">
                <div class="col-12">
                    <div class="d-flex flex-between-center mb-3">
                        ...
                        <a class="btn btn-link btn-lg p-0 d-none d-md-block" href="{{ route('products.index', ['type' => 'service']) }}">
                            ...
                            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                                <div class="card h-100 hover-shadow">
                                    <div class="card-body p-3">
                                        <a href="{{ route('product.show', $service->slug) }}" class="text-decoration-none">
                                            <div class="text-center mb-2">
                                                <i class="fas fa-concierge-bell text-primary" style="font-size: 2rem;"></i>
                                            </div>
                                            <h6 class="mb-1 fs-9 text-body-emphasis line-clamp-2">{{ $service->name }}</h6>
                                            <p class="fs-10 text-body-tertiary mb-1">{{ $service->store->name }}</p>
                                            <p class="text-primary fw-bold mb-0">RM{{ number_format($service->regular_price, 2) }}</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row g-4 mb-6">
                <div class="col-12">
                    <div class="d-flex flex-between-center mb-3">
                        ...
                        <a class="btn btn-link btn-lg p-0 d-none d-md-block" href="{{ route('products.index', ['type' => 'pharmacy']) }}">
                            View all<span class="fas fa-chevron-right fs-9 ms-1"></span>
                        </a>
                    </div>
                    ...
                    <div class="row g-3">
                        @foreach($pharmacy as $drug)
                            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                                <div class="card h-100 hover-shadow">
                                    <div class="card-body p-3">
                                        <a href="{{ route('product.show', $drug->slug) }}" class="text-decoration-none">
                                            ...
                                            @endif
                                            <h6 class="mb-1 fs-9 text-body-emphasis line-clamp-2">{{ $drug->name }}</h6>
                                            @if($drug->requires_prescription)
                                                <p class="fs-10 text-danger mb-1">
                                                    <i class="fas fa-prescription me-1"></i>Rx Required
                                                </p>
                                            @endif
                                            <p class="text-success fw-bold mb-0">RM{{ number_format($drug->regular_price, 2) }}</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row flex-center mb-15 mt-11 gy-6">
                <div class="col-auto">
                    <img class="d-dark-none" src="{{ asset('assets/img/spot-illustrations/light_30.png') }}" alt="" width="305" />
                    <img class="d-light-none" src="{{ asset('assets/img/spot-illustrations/dark_30.png') }}" alt="" width="305" />
                </div>
                <div class="col-auto">
    ...
    function toggleWishlist(productId, button) {
        ...
        if (heartFull.classList.contains('d-block-hover')) {
