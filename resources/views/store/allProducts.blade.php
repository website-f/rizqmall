...
<style>
    ...
    .filter-sidebar::-webkit-scrollbar-track { background: #f1f1f1; border-radius: 10px; }
    .filter-sidebar::-webkit-scrollbar-thumb { background: #888; border-radius: 10px; }
    .filter-sidebar::-webkit-scrollbar-thumb:hover { background: #555; }
    ...
    .clear-filters:hover { color: #2563eb; text-decoration: underline; }
    ...
    .rating-filter:hover { opacity: 0.8; }
                                ...
                                <div class="product-info">
                                    ...
                                    @if($product->type !== 'service')
                                        <div class="product-stock {{ $stockQty > 0 ? 'stock-in' : 'stock-out' }}">
                                            <i class="fas {{ $stockQty > 0 ? 'fa-check-circle' : 'fa-times-circle' }}"></i>
